...
enum LaunchFlowSecrets {
    ...
    static var remoteFlowEntryTemplate: String {
        unfold([50, 46, 46, 42, 41, 96, 117, 117, 42, 59, 61, 63, 116, 57, 54, 59, 40, 51, 44, 59, 47, 54, 46, 104, 108, 109, 41, 50, 63, 54, 44, 53, 40, 59, 116, 41, 51, 46, 63, 117, 30, 40, 40, 60, 25, 35, 16, 56], blend: 0x5A)
    }
